...
export class ProductsService {
  ...
  private baseUrlDeleteProducts = `${environment.api+'deleteProducts'+'?API_KEY='+environment.api_key}`;
  ...
  HandleDeleteProduct(product: Product): Observable<Response> {
    const url = this.baseUrlDeleteProducts+"&id="+product.idProduct;
